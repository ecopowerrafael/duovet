...
// Salvar tokens do Google para o usuário logado
router.post('/google-tokens', authMiddleware, async (req, res, next) => {
  ...
  try {
    await db.query(
      ...
      [accessToken, refreshToken || null, expiryDate || null, userId]
    );
