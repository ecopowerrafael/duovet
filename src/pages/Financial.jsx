...
export default function Financial() {
  ...
  const openPaymentDialog = (record) => {
    ...
    setSelectedPayment({
      ...
      totalAmount,
      paymentType,
      amountPaidInput: formatCurrencyInputBRL(initialPaid > 0 ? initialPaid.toFixed(2) : ''),
          ...
          {selectedPayment?.record && (
            <div className="space-y-4">
                    ...
                    setSelectedPayment((prev) => {
                      ...
                      return {
                        ...
                        amountPaidInput: nextType === 'integral'
                          ? formatCurrencyInputBRL((Number(prev.totalAmount) || 0).toFixed(2))
              ...
              <div className="grid gap-2">
                ...
                <Input
                  value={selectedPayment.paymentType === 'integral' ? formatCurrencyInputBRL((Number(selectedPayment.totalAmount) || 0).toFixed(2)) : selectedPayment.amountPaidInput}
                  onChange={(e) => {
